    ...
    <form id="form1" runat="server">
        ...
        <table style="width:100%;">
            ...
            <tr>
                ...
                <td>
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Reg_User_Reniec.aspx">NO TIENES CUENTA ENTRA AQUI</asp:HyperLink>
                </td>
            </tr>
            <tr>
                <td class="auto-style3">&nbsp;</td>
                <td>
                    <asp:Button ID="btningresar" runat="server" Text="INGRESAR" Width="133px" OnClick="btningresar_Click" />
                </td>
            </tr>
        </table>
    </form>
